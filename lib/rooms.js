...
import { dealInitialHands, GAME_PHASE_DRAFTING } from "./game-rules.js";
...
export function startRoom(room, playerId, options = {}) {
  ...
  // Temporary compatibility: start still deals hands; drafting six cards later replaces hand for arrange.
